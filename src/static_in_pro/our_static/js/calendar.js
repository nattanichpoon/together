...
window.onload = function(){
    ...
    var shared_calendar = get_shared_calendar(day_no, days, day_name);
    var members = get_members();
    document.getElementById("shared-calendar-month-year").innerHTML = month_name[month]+" "+year;
    document.getElementById("shared-calendar-dates").appendChild(shared_calendar);
    document.getElementById("memberinfo-title").innerHTML = "Member Information";
...
function get_shared_calendar(day_no, days, day_name){
    var table = document.createElement('table');
    //table.style.backgroundColor="#d89d47";
    var tr = document.createElement('tr');
    //tr.style.backgroundColor="#ffffff";
